...
class DoctorPortalFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.lbl_title = ctk.CTkLabel(self.top_bar, text="✚ Vitalink | Doctor Portal", font=ctk.CTkFont(size=20, weight="bold"), text_color="#3D59AB")
...
class DoctorCentralMenu(ctk.CTkFrame):
    def __init__(self, parent, portal):
        super().__init__(parent, fg_color="transparent")
        
        user = getattr(portal.controller, "current_user_name", "Doctor")
        ...
        self.create_tile(grid_frame, "Patient Admission", "👤+", lambda: messagebox.showinfo("Info", "Coming soon :)"), 0, 0)
        self.create_tile(grid_frame, "Prescription Issuance", "💊", lambda: messagebox.showinfo("Info", "Coming soon :)"), 0, 1)
        self.create_tile(grid_frame, "Patient Record Processing", "📋", lambda: messagebox.showinfo("Info", "Coming soon :)"), 1, 0)
        self.create_tile(grid_frame, "Profile Management", "👤", lambda: messagebox.showinfo("Info", "Coming soon :)"), 1, 1)
