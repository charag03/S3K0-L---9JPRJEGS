...
class InvManagerCentralMenu(ctk.CTkFrame):
    def __init__(self, parent, portal):
        super().__init__(parent, fg_color="transparent")
        
        user = getattr(portal.controller, "current_user_name", "Inventory Manager")
        ...
        self.create_tile(grid_frame, "Order of Equipment and Medicines", "🚚", lambda: messagebox.showinfo("Info", "Coming soon :)"), 0, 0)
        self.create_tile(grid_frame, "Manage Requests for Medicines and Equipment", "📩💊", lambda: messagebox.showinfo("Info", "Coming soon :)"), 0, 1)
