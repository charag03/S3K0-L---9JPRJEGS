...
class PharmacistCentralMenu(ctk.CTkFrame):
    def __init__(self, parent, portal):
        super().__init__(parent, fg_color="transparent")
        
        user = getattr(portal.controller, "current_user_name", "Pharmacist")
        ...
        self.create_tile(grid_frame, "Drug Administration", "💊", lambda: messagebox.showinfo("Info", "Coming soon :)"), 0, 0)
        self.create_tile(grid_frame, "Request for Medicines and Equipment", "📦", lambda: messagebox.showinfo("Info", "Coming soon :)"), 0, 1)
